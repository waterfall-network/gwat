...
var eip2200Tests = []struct {
	...
	{1, 2306, "0x600160005560006000556001600055", 2306, 0, ErrOutOfGas},        // 1 -> 1 (2300 sentry + 2xPUSH)
	{1, 18307, "0x600060005560016000556000600055", 10818, 19200, nil},          // 1 -> 1 (2301 sentry + 2xPUSH)
}
