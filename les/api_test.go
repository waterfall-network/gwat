...
import (
	...
	ethdownloader "gitlab.waterfall.network/waterfall/protocol/gwat/eth/downloader"
	...
	"gitlab.waterfall.network/waterfall/protocol/gwat/p2p/simulations"
...
func NewAdapter(adapterType string, services adapters.LifecycleConstructors) (adapter adapters.NodeAdapter, teardown func(), err error) {
	...
	case "exec":
		baseDir, err0 := os.TempDir("", "les-test")
		if err0 != nil {
