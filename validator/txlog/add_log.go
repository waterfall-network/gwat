...
var (
	...
	//validator sync op
	EvtActivateLogSignature      = crypto.Keccak256Hash([]byte("activation"))
	EvtDeactivateLogSignature    = crypto.Keccak256Hash([]byte("deactivation"))
	EvtUpdateBalanceLogSignature = crypto.Keccak256Hash([]byte("UpdateBalance"))
)
