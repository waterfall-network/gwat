...
**1. Set up Gwat following the instructions in README.md.**

**2. Fork the Gwat repo.**

Sign in to your Github account or create a new account if you do not have one already. Then navigate your browser to https://github.com/waterfall-network/gwat. In the upper right hand corner of the page, click “fork”. This will create a copy of the Gwat repo in your account.

**3. Create a local clone of Gwat.**

```
$ mkdir -p $GOPATH/src/github.com/waterfall-network
$ cd $GOPATH/src/github.com/waterfall-network
$ git clone https://github.com/waterfall-network/gwat.git
$ cd $GOPATH/src/github.com/waterfall-network/gwat
```

**4. Link your local clone to the fork on your Github repo.**

```
$ git remote add mygwatrepo https://github.com/<your_github_user_name>/gwat.git
```
...
**12. Fetch any changes that have occurred in the Waterfall Network Gwat repo since you started work.**
...
```
$ git merge-base feature-in-progress-branch gwat/main
```
