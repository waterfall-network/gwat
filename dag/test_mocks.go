...
func (m *MockethDownloader) SyncChainBySpines(baseSpine common.Hash, spines common.HashArray, syncMode types.SyncMode) error {
	m.ctrl.T.Helper()
...
func (mr *MockethDownloaderMockRecorder) SyncChainBySpines(baseSpine, spines, finEpoch interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SyncChainBySpines", reflect.TypeOf((*MockethDownloader)(nil).SyncChainBySpines), baseSpine, spines, finEpoch)
}
