...
func (mr *MockBlockChainMockRecorder) RollbackFinalization(finNr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RollbackFinalization", reflect.TypeOf((*MockBlockChain)(nil).RollbackFinalization), finNr)
}
...
func (m *MockBlockChain) WriteFinalizedBlock(finNr uint64, block *types.Block, receipts []*types.Receipt, logs []*types.Log, state *state.StateDB, isHead bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WriteFinalizedBlock", finNr, block, receipts, logs, state, isHead)
	ret0, _ := ret[0].(error)
	return ret0
}

// WriteFinalizedBlock indicates an expected call of WriteFinalizedBlock.
func (mr *MockBlockChainMockRecorder) WriteFinalizedBlock(finNr, block, receipts, logs, state, isHead interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WriteFinalizedBlock", reflect.TypeOf((*MockBlockChain)(nil).WriteFinalizedBlock), finNr, block, receipts, logs, state, isHead)
}
