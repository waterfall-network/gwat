...
func TestEth66Messages(t *testing.T) {
	...
	for i, tc := range []struct {
	...
	}{
		{
			...
			common.FromHex("e9820457e5c0a000000000000000000000000000000000000000000000000000000000deadc0de050580"),
		},
		{
			GetBlockHeadersPacket66{1111, &GetBlockHeadersPacket{&common.HashArray{}, &HashOrNumber{common.Hash{}, 9999}, 5, 5, false}},
			common.FromHex("cb820457c7c082270f050580"),
		},
		{
			BlockHeadersPacket66{1111, BlockHeadersPacket{header}},
			common.FromHex(""),
		},
		{
