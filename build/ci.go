...
import (
	...
	"github.com/waterfall-foundation/gwat/crypto/signify"
	"github.com/waterfall-foundation/gwat/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/waterfall-foundation/gwat/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/waterfall-foundation/gwat/mobile")
